...
PriorNode(PartitionedDistribution([Gaussian(m=25.0,V=12.0),Gaussian(m=10.0,V=12.0),Gaussian(m=150.,V=12.)]),id=:m1_min_1)
PriorNode(PartitionedDistribution([Gamma(a=1,b=1.),Gamma(a=1, b=1.), Gamma(a=1,b=1.)]),id=:w1_min_1)
PriorNode(Dirichlet(2.*ones(length(N))),id=:pi_min_1)
