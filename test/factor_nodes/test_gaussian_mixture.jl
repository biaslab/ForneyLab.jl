...
@testset "VBGaussianMixture1" begin
    ...
    @test isApplicable(VBGaussianMixture1, 1) 
...
@testset "VBGaussianMixture2" begin
    ...
    @test isApplicable(VBGaussianMixture2, 2) 
...
@testset "VBGaussianMixture3" begin
    ...
    @test isApplicable(VBGaussianMixture3, 3) 
...
@testset "VBGaussianMixture4" begin
    ...
    @test isApplicable(VBGaussianMixture4, 4) 
...
@testset "VBGaussianMixture5" begin
    ...
    @test isApplicable(VBGaussianMixture5, 5) 
...
@testset "VBGaussianMixture6" begin
    ...
    @test isApplicable(VBGaussianMixture6, 6) 
