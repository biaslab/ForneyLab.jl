...
@testset "VBGaussianMixtureM" begin
    ...
    @test ruleVBGaussianMixtureM(ProbabilityDistribution(Multivariate, Gaussian, m=[8.5], v=mat(0.5)), ProbabilityDistribution(Univariate, Bernoulli, p=0.2), nothing, ProbabilityDistribution(MatrixVariate, Wishart, nu=2.0, v=mat(0.25)), ProbabilityDistribution(Multivariate, Gaussian, m=[0.0], v=mat(1.0)), ProbabilityDistribution(MatrixVariate, Wishart, nu=4.0, v=mat(0.5))) == Message(Multivariate, Gaussian, m=[8.5], v=mat(9.999999999999998))
    ...
    @test ruleVBGaussianMixtureM(ProbabilityDistribution(Multivariate, Gaussian, m=[8.5], v=mat(0.5)), ProbabilityDistribution(Univariate, Bernoulli, p=0.2), ProbabilityDistribution(Multivariate, Gaussian, m=[0.0], v=mat(1.0)), ProbabilityDistribution(MatrixVariate, Wishart, nu=2.0, v=mat(0.25)), nothing, ProbabilityDistribution(MatrixVariate, Wishart, nu=4.0, v=mat(0.5))) == Message(Multivariate, Gaussian, m=[8.5], v=mat(0.6249999999999999))
    ...
    @test ruleVBGaussianMixtureM(ProbabilityDistribution(Multivariate, Gaussian, m=[8.5], v=mat(0.5)), ProbabilityDistribution(Univariate, Categorical, p=[0.2, 0.8]), nothing, ProbabilityDistribution(MatrixVariate, Wishart, nu=2.0, v=mat(0.25)), ProbabilityDistribution(Multivariate, Gaussian, m=[0.0], v=mat(1.0)), ProbabilityDistribution(MatrixVariate, Wishart, nu=4.0, v=mat(0.5))) == Message(Multivariate, Gaussian, m=[8.5], v=mat(9.999999999999998))
end
...
@testset "VBGaussianMixtureW" begin
    ...
    @test ruleVBGaussianMixtureW(ProbabilityDistribution(Multivariate, Gaussian, m=[8.5], v=mat(0.5)), ProbabilityDistribution(Univariate, Bernoulli, p=0.2), ProbabilityDistribution(Multivariate, Gaussian, m=[5.0], v=mat(2.0)), nothing, ProbabilityDistribution(Multivariate, Gaussian, m=[10.0], v=mat(3.0)), ProbabilityDistribution(MatrixVariate, Wishart, nu=4.0, v=mat(0.5))) == Message(MatrixVariate, Wishart, nu=2.2, v=mat(0.33898305084745767))
    ...
    @test ruleVBGaussianMixtureW(ProbabilityDistribution(Multivariate, Gaussian, m=[8.5], v=mat(0.5)), ProbabilityDistribution(Univariate, Bernoulli, p=0.2), ProbabilityDistribution(Multivariate, Gaussian, m=[5.0], v=mat(2.0)), ProbabilityDistribution(MatrixVariate, Wishart, nu=2.0, v=mat(0.25)), ProbabilityDistribution(Multivariate, Gaussian, m=[10.0], v=mat(3.0)), nothing) == Message(MatrixVariate, Wishart, nu=2.8, v=mat(0.2173913043478261))
    ...
    @test ruleVBGaussianMixtureW(ProbabilityDistribution(Multivariate, Gaussian, m=[8.5], v=mat(0.5)), ProbabilityDistribution(Univariate, Categorical, p=[0.2, 0.8]), ProbabilityDistribution(Multivariate, Gaussian, m=[5.0], v=mat(2.0)), nothing, ProbabilityDistribution(Multivariate, Gaussian, m=[10.0], v=mat(3.0)), ProbabilityDistribution(MatrixVariate, Wishart, nu=4.0, v=mat(0.5))) == Message(MatrixVariate, Wishart, nu=2.2, v=mat(0.33898305084745767))
end
...
@testset "VBGaussianMixtureZBer" begin
    ...
    @test ruleVBGaussianMixtureZBer(ProbabilityDistribution(Multivariate, Gaussian, m=[8.5], v=mat(0.5)), nothing, ProbabilityDistribution(Multivariate, Gaussian, m=[5.0], v=mat(2.0)), ProbabilityDistribution(MatrixVariate, Wishart, nu=2.0, v=mat(0.25)), ProbabilityDistribution(Multivariate, Gaussian, m=[10.0], v=mat(3.0)), ProbabilityDistribution(MatrixVariate, Wishart, nu=4.0, v=mat(0.5))) == Message(Univariate, Bernoulli, p=0.7713458788198754)
end
...
@testset "VBGaussianMixtureZCat" begin
    ...
    @test ruleVBGaussianMixtureZCat(ProbabilityDistribution(Multivariate, Gaussian, m=[8.5], v=mat(0.5)), nothing, ProbabilityDistribution(Multivariate, Gaussian, m=[5.0], v=mat(2.0)), ProbabilityDistribution(MatrixVariate, Wishart, nu=2.0, v=mat(0.25)), ProbabilityDistribution(Multivariate, Gaussian, m=[10.0], v=mat(3.0)), ProbabilityDistribution(MatrixVariate, Wishart, nu=4.0, v=mat(0.5))) == Message(Univariate, Categorical, p=[0.7713458788198754, 0.22865412118012463])
end
...
@testset "VBGaussianMixtureOut" begin
    ...
    @test ruleVBGaussianMixtureOut(nothing, ProbabilityDistribution(Univariate, Bernoulli, p=0.2), ProbabilityDistribution(Multivariate, Gaussian, m=[5.0], v=mat(2.0)), ProbabilityDistribution(MatrixVariate, Wishart, nu=2.0, v=mat(0.25)), ProbabilityDistribution(Multivariate, Gaussian, m=[10.0], v=mat(3.0)), ProbabilityDistribution(MatrixVariate, Wishart, nu=4.0, v=mat(0.5))) == Message(Multivariate, Gaussian, m=[9.705882352941176], v=mat(0.588235294117647))
    ...
    @test ruleVBGaussianMixtureOut(nothing, ProbabilityDistribution(Univariate, Categorical, p=[0.2, 0.8]), ProbabilityDistribution(Multivariate, Gaussian, m=[5.0], v=mat(2.0)), ProbabilityDistribution(MatrixVariate, Wishart, nu=2.0, v=mat(0.25)), ProbabilityDistribution(Multivariate, Gaussian, m=[10.0], v=mat(3.0)), ProbabilityDistribution(MatrixVariate, Wishart, nu=4.0, v=mat(0.5))) == Message(Multivariate, Gaussian, m=[9.705882352941176], v=mat(0.588235294117647))
end
...
@testset "averageEnergy" begin
    ...
    # Multivariate
    marg_out = ProbabilityDistribution(Multivariate, Gaussian, m=[0.0], v=mat(1.0))
    marg_switch = ProbabilityDistribution(Univariate, Bernoulli, p=0.2)
    marg_mean_1 = ProbabilityDistribution(Multivariate, Gaussian, m=[1.0], v=mat(2.0))
    marg_prec_1 = ProbabilityDistribution(MatrixVariate, Wishart, nu=4.0, v=mat(1/6))
    marg_mean_2 = ProbabilityDistribution(Multivariate, Gaussian, m=[3.0], v=mat(4.0))
