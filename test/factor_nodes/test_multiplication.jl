...
@testset "SPMultiplicationOutVGP" begin
    ...
    @test ruleSPMultiplicationOutVGP(nothing, Message(Multivariate, Gaussian, m=[1.0], v=[3.0].'), Message(MatrixVariate, PointMass, m=[2.0].')) == Message(Multivariate, Gaussian, m=[2.0], v=[12.0].')
end
...
@testset "SPMultiplicationOutVPG" begin
    ...
    @test ruleSPMultiplicationOutVPG(nothing, Message(MatrixVariate, PointMass, m=[2.0].'), Message(Multivariate, Gaussian, m=[1.0], v=[3.0].')) == Message(Multivariate, Gaussian, m=[2.0], v=[12.0].')
end
...
@testset "SPMultiplicationOutVPP" begin
    ...
    @test ruleSPMultiplicationOutVPP(nothing, Message(MatrixVariate, PointMass, m=[2.0].'), Message(Multivariate, PointMass, m=[1.0])) == Message(Multivariate, PointMass, m=[2.0])
    @test ruleSPMultiplicationOutVPP(nothing, Message(Multivariate, PointMass, m=[2.0]), Message(MatrixVariate, PointMass, m=[1.0].')) == Message(Multivariate, PointMass, m=[2.0])
end
...
@testset "SPMultiplicationIn1GVP" begin
    ...
    @test ruleSPMultiplicationIn1GVP(Message(Multivariate, Gaussian, m=[1.0], v=[3.0].'), nothing, Message(MatrixVariate, PointMass, m=[2.0].')) == Message(Multivariate, Gaussian, m=[0.5], v=[0.75].')
end
...
@testset "SPMultiplicationIn1PVP" begin
    ...
    @test ruleSPMultiplicationIn1PVP(Message(Multivariate, PointMass, m=[1.0]), nothing, Message(MatrixVariate, PointMass, m=[2.0].')) == Message(Multivariate, PointMass, m=[0.5])
end
...
@testset "SPMultiplicationIn2GPV" begin
    ...
    @test ruleSPMultiplicationIn2GPV(Message(Multivariate, Gaussian, m=[1.0], v=[3.0].'), Message(MatrixVariate, PointMass, m=[2.0].'), nothing) == Message(Multivariate, Gaussian, m=[0.5], v=[0.75].')
end
...
@testset "SPMultiplicationIn2PPV" begin
    ...
    @test ruleSPMultiplicationIn2PPV(Message(Multivariate, PointMass, m=[1.0]), Message(MatrixVariate, PointMass, m=[2.0].'), nothing) == Message(Multivariate, PointMass, m=[0.5])
end
