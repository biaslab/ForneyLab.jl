...
import LinearAlgebra: I, det, diag
...
@testset "unsafe statistics" begin
    ...
    @test unsafeWeightedMeanPrecision(ProbabilityDistribution(Multivariate, GaussianMeanVariance, m=[2.0], v=mat(4.0))) == ([0.5], PDMat(mat(0.25)))
end
