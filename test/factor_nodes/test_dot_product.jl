...
@testset "SPDotProductIn1GNP" begin
    ...
    @test ruleSPDotProductIn1GNP(Message(Univariate, GaussianWeightedMeanPrecision, xi=3.0, w=2.0), nothing, Message(Multivariate, PointMass, m=[4.0])) == Message(Multivariate, GaussianWeightedMeanPrecision, xi=[12.0], w=mat(32.))
end
...
@testset "SPDotProductIn2GPN" begin
    ...
    @test ruleSPDotProductIn2GPN(Message(Univariate, GaussianWeightedMeanPrecision, xi=3.0, w=2.0), Message(Multivariate, PointMass, m=[4.0]), nothing) == Message(Multivariate, GaussianWeightedMeanPrecision, xi=[12.0], w=mat(32.))
end
