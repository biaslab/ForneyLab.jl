...
@testset "SVBGaussianMeanPrecisionOutVGD" begin
    ...
    @test ruleSVBGaussianMeanPrecisionOutVGD(nothing, Message(Multivariate, Gaussian, m=[3.0], v=[4.0].'), ProbabilityDistribution(MatrixVariate, Wishart, v=[0.25].', nu=2.0)) == Message(Multivariate, Gaussian, m=[3.0], v=[6.0].')
end
