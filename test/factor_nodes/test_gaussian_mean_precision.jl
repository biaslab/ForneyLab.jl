...
@testset "VBGaussianMeanPrecision1" begin
    ...
    @test isApplicable(VBGaussianMeanPrecision1, 1) 
    @test !isApplicable(VBGaussianMeanPrecision1, 2) 
...
@testset "VBGaussianMeanPrecision2" begin
    ...
    @test isApplicable(VBGaussianMeanPrecision2, 2) 
...
@testset "VBGaussianMeanPrecision3" begin
    ...
    @test isApplicable(VBGaussianMeanPrecision3, 3) 
