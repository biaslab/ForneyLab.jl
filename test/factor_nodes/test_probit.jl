...
@testset "averageEnergy" begin
    @test averageEnergy(Probit, Distribution(Univariate, Bernoulli, p=1.0), Distribution(Univariate, GaussianMeanVariance, m=0.0, v=1.0)) == 1.0000000289419368
    @test averageEnergy(Probit, Distribution(Univariate, PointMass, m=1.0), Distribution(Univariate, GaussianMeanVariance, m=0.0, v=1.0)) == 1.0000000289419368
end
