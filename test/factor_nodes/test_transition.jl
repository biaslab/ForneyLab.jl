...
@testset "SPTransitionOutVCP" begin
    @test SPTransitionOutVCP <: SumProductRule{Transition}
    @test outboundType(SPTransitionOutVCP) == Message{Categorical}
    @test isApplicable(SPTransitionOutVCP, [Void, Message{Categorical}, Message{PointMass}]) 
    @test !isApplicable(SPTransitionOutVCP, [Message{Categorical}, Void, Message{PointMass}]) 

    @test ruleSPTransitionOutVCP(nothing, Message(Univariate, Categorical, p=[0.1, 0.4, 0.5]), Message(MatrixVariate, PointMass, m=[0.2 0.1 0.7; 0.4 0.3 0.3; 0.1 0.6 0.3])) == Message(Univariate, Categorical, p=[0.3660714285714285, 0.27678571428571425, 0.35714285714285715])
end

@testset "SPTransitionIn1CVP" begin
    @test SPTransitionIn1CVP <: SumProductRule{Transition}
    @test outboundType(SPTransitionIn1CVP) == Message{Categorical}
    @test isApplicable(SPTransitionIn1CVP, [Message{Categorical}, Void, Message{PointMass}]) 

    @test ruleSPTransitionIn1CVP(Message(Univariate, Categorical, p=[0.1, 0.4, 0.5]), nothing, Message(MatrixVariate, PointMass, m=[0.2 0.1 0.7; 0.4 0.3 0.3; 0.1 0.6 0.3])) == Message(Univariate, Categorical, p=[0.23000000000000004, 0.43, 0.33999999999999997])
end
...
@testset "VBTransitionOut" begin
    ...
    @test isApplicable(VBTransitionOut, [Void, ProbabilityDistribution, ProbabilityDistribution]) 
...
@testset "VBTransitionIn1" begin
    ...
    @test isApplicable(VBTransitionIn1, [ProbabilityDistribution, Void, ProbabilityDistribution]) 
...
@testset "VBTransitionA" begin
    ...
    @test isApplicable(VBTransitionA, [ProbabilityDistribution, ProbabilityDistribution, Void]) 
...
@testset "SVBTransitionOutVCD" begin
    ...
    @test isApplicable(SVBTransitionOutVCD, [Void, Message{Categorical}, ProbabilityDistribution]) 
...
@testset "SVBTransitionIn1CVD" begin
    ...
    @test isApplicable(SVBTransitionIn1CVD, [Message{Categorical}, Void, ProbabilityDistribution]) 
...
@testset "SVBTransitionADV" begin
    ...
    @test isApplicable(SVBTransitionADV, [ProbabilityDistribution, Void]) 
