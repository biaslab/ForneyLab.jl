...
@testset "PosteriorFactor" begin
    ...
    @test q_m.breaker_interfaces == Set{Interface}()
    ...
    @test q_w.breaker_interfaces == Set{Interface}()
    ...
    @test q_m_w.breaker_interfaces == Set{Interface}()
    ...
    @test q_y.breaker_interfaces == Set{Interface}()
