...
facts("InferenceScheme integration tests") do
    context("setVagueMarginals() should set vague marginals at the appropriate places") do
        ...
        @fact scheme.approximate_marginals[(g_nodes[1], m_subgraph)] => vague(GaussianDistribution)
        @fact scheme.approximate_marginals[(g_nodes[2], m_subgraph)] => vague(GaussianDistribution)
        @fact scheme.approximate_marginals[(g_nodes[3], m_subgraph)] => vague(GaussianDistribution)
        @fact scheme.approximate_marginals[(g_nodes[1], gam_subgraph)] => vague(GammaDistribution)
        @fact scheme.approximate_marginals[(g_nodes[2], gam_subgraph)] => vague(GammaDistribution)
        @fact scheme.approximate_marginals[(g_nodes[3], gam_subgraph)] => vague(GammaDistribution)
        @fact scheme.approximate_marginals[(g_nodes[1], y1_subgraph)] => vague(GaussianDistribution)
        @fact scheme.approximate_marginals[(g_nodes[2], y2_subgraph)] => vague(GaussianDistribution)
        @fact scheme.approximate_marginals[(g_nodes[3], y3_subgraph)] => vague(GaussianDistribution)
        ...
        @fact scheme.approximate_marginals[(g_nodes[1], m_gam_subgraph)] => vague(NormalGammaDistribution)
        @fact scheme.approximate_marginals[(g_nodes[2], m_gam_subgraph)] => vague(NormalGammaDistribution)
        @fact scheme.approximate_marginals[(g_nodes[3], m_gam_subgraph)] => vague(NormalGammaDistribution)
        @fact scheme.approximate_marginals[(g_nodes[1], y1_subgraph)] => vague(GaussianDistribution)
        @fact scheme.approximate_marginals[(g_nodes[2], y2_subgraph)] => vague(GaussianDistribution)
        @fact scheme.approximate_marginals[(g_nodes[3], y3_subgraph)] => vague(GaussianDistribution)
    end
