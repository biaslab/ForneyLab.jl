...
function sumProduct!(   node::GainAdditionNode,
    ...
    additionBackwardRule!(dist_temp, in2.payload, out.payload)
    outbound_dist = ensureMessage!(node.interfaces[outbound_interface_index], MvGaussianDistribution).payload
