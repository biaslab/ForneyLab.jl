...
@doc "Univariate probability distribution. Subtypes: $(format(subtypes(Univariate)))" Univariate
@doc "Multivariate probability distribution. Subtypes: $(format(subtypes(Multivariate)))" Multivariate
