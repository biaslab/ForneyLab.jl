...
function unsafeBoundMean(marg_in1::ProbabilityDistribution{Multivariate}, marg_xi::ProbabilityDistribution{Multivariate, PointMass}, marg_a::ProbabilityDistribution{Univariate, PointMass})
