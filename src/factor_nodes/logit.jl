...
function averageEnergy(::Type{Logit}, marg_out::ProbabilityDistribution{Univariate}, marg_in1::ProbabilityDistribution{Univariate}, marg_xi::ProbabilityDistribution{Univariate, PointMass})
