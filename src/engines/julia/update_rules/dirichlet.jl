...
ruleVBDirichletOut(marg_out::Any, marg_a::Distribution{V}) where V<:VariateType = Message(V, Dirichlet, a=unsafeMean(marg_a))

function ruleVBDirichletIn1(marg_out::Distribution{Multivariate}, marg_a::Any)
