...
ruleSPBetaOutVPP(msg_out::Void, msg_a::Message{PointMass, Univariate}, msg_b::Message{PointMass, Univariate}) = Message(Univariate, Beta, a=msg_a.dist.params[:m], b=msg_b.dist.params[:m])
