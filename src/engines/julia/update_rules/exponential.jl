...
function ruleSPExponentialOutNG(msg_out::Nothing, 
    ...
    d_in1 = convert(Distribution{Univariate, Gaussian{Moments}}, msg_in1.dist)
...
ruleSPExponentialIn1LN(msg_out::Message{LogNormal, Univariate}, msg_in1::Nothing) = 
	Message(Univariate, Gaussian{Moments}, m=msg_out.dist.params[:m], v=msg_out.dist.params[:s])
