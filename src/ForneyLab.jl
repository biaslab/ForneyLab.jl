...
include("factor_nodes/gaussian_mean_variance_constraint.jl")
include("factor_nodes/categorical_constraint.jl")
include("factor_nodes/bernoulli_constraint.jl")
...
include("update_rules/gaussian_mean_variance_constraint.jl")
include("update_rules/categorical_constraint.jl")
include("update_rules/bernoulli_constraint.jl")
